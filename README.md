...
### Класс Group
Класс для работы с CSV-хранилищем студентов, реализующий:
...
2. **CRUD-операции**:
   ...
   - `remove(fio)` - удаление студента по ФИО
   - `update(fio, **fields)` - обновление полей студента

3. **Дополнительные методы**:
   - `stats()` - получение статистики по студентам
...
```
# <h4>Код с тестами к файлу group.py<h4>
...
![](./images/lb09/img_1.png)

![](./images/lb09/img_2.png)

![](./images/lb09/img_3.png)

![](./images/lb09/img_4.png)

![](./images/lb09/img_5.png)

![](./images/lb09/img_6.png)

![](./images/lb09/img_7.png)

![](./images/lb09/img_8.png)

![](./images/lb09/img_9.png)
...
Реализовала класс Student для представления информации о студенте. Класс содержит атрибуты для хранения основных данных:
